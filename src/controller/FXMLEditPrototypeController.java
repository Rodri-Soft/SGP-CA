...
public class FXMLEditPrototypeController implements Initializable {
    ...
    private Prototype prototypeSelected = FXMLPrototypeListController.prototypeSelected;

    @Override
    public void initialize(URL location, ResourceBundle resources) {

        validateText();
        textFieldTitle.setText(prototypeSelected.getTitle());
        textFieldAdacemicDegree.setText(prototypeSelected.getAcademicdegree());
        comboBoxProject.setValue(prototypeSelected.getIdInvestigationProject());
    ...
    private void clickRegister(ActionEvent event) {
        ...
        try{
            Prototype prototype = PROTOTYPE_DAO.foundPrototypeById(prototypeSelected.getIdPrototype());

            if((validateTitle == true) && (validateAcademicDegree == true)  && (comboBoxProject.getValue()!=null)){
                prototype.setTitle(textFieldTitle.getText());
                prototype.setAcademicdegree(textFieldAdacemicDegree.getText());
                prototype.setIdInvestigationProject(comboBoxProject.getValue());

                PROTOTYPE_DAO.updatePrototype(prototype);
