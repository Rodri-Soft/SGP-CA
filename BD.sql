...
INSERT INTO `lgac-preliminaryproject` VALUES ('LPP-2','Tecnologias de software','PLP-3'),('LPP-3','Tecnologías de software','PLP-4'),('LPP-4','Tecnologías de software','PLP-5'),('LPP-5','Tecnologías de software','PLP-6'),('LPP-6','no le sabe','PLP-7'),('LPP-7','no le sabe no le sabe','PLP-7'),('LPP-8','Tecnologías de software','PLP-8');
...
INSERT INTO `member` VALUES ('MOLK010131MNELPTA0','Jorge Octavio Ocharán Hernández','2021-05-04','ocharan@uv.mx','2281963700','Colaborador','','AGP-2'),('SAMR011202HVZNNDA9','José Rodrigo Sánchez Méndez','2001-12-02','zs19013985@estudiantes.uv.mx','2281963700','Colaborador','','AGP-1'),('SASO750909HDFNNS05','María Karen Cortés Verdín ','1985-06-03','himno@gmail.com','2281776699','Responsable','','AGP-1');
...
CREATE TABLE `preliminaryproject` (
  ...
  CONSTRAINT `idInvestigationProject5` FOREIGN KEY (`idInvestigationProject`) REFERENCES `investigationproject` (`idInvestigationProject`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `preliminaryproject` VALUES ('PLP-3','Titulo','Descricion','2021-06-25','Asignado','tesis',12,'IVP-2'),('PLP-4','Poryecto Poryecto','Anteproyecto de pruena','2021-06-01','Asignado','Arituculo',23,NULL),('PLP-5','Proyectito','Tesina del proyectito','2021-06-04','Asignado','Tesina',12,NULL),('PLP-6','Aticulo','articulo de pedrito','2021-06-04','Asignado','Articulo',18,'IVP-2'),('PLP-7','Anteproyecto','descripción','2021-06-04','Terminado','Tesina',12,'IVP-2'),('PLP-8','Prueba pryeba','descripción','2021-06-26','Asignado','Tesis',1,'IVP-2');
...
CREATE TABLE `preliminaryproject-codirector` (
  ...
  `memberCurp` varchar(18) DEFAULT NULL,
  `idPreliminaryProject` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idPreliminaryProjectCodirector`),
  KEY `memberCURP_idx` (`memberCurp`),
  ...
  CONSTRAINT `memberCURP` FOREIGN KEY (`memberCurp`) REFERENCES `member` (`curp`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `preliminaryproject-codirector` VALUES ('PPC-3','MOLK010131MNELPTA0','PLP-4'),('PPC-4','SASO750909HDFNNS05','PLP-3'),('PPC-5','MOLK010131MNELPTA0','PLP-6'),('PPC-6','MOLK010131MNELPTA0','PLP-7'),('PPC-7','SASO750909HDFNNS05','PLP-8');
...
INSERT INTO `preliminaryproject-studentinformation` VALUES ('PSN-12','Jose rodrigo','S19013985@ESTUDIANTES.UV.MX','PLP-7'),('PSN-13','Guillermo','Guillermo@gmail.com','PLP-8'),('PSN-5','Rodri rodri','rodrigo@gmaail.com','PLP-3'),('PSN-6','José Rodrigo Sánchez Méndez','S19013985@estudiantes.uv.mx','PLP-4'),('PSN-7','Jose Rodrigo','rodri@gmail.com','PLP-5'),('PSN-8','Pedro','pedrito@estudiantes.uv.mx','PLP-6');
...
INSERT INTO `strategy` VALUES ('STR-1','Desarrollo de filtro para docencia de tiempo completo','Conocer los programas de intercambio docente con otras universidades o facultades de área técnica','Obtener la acreditación de un nuevo integrante del CA mediante su alta en PRODEP y en el sistema PLATA UV',1,'Incorporación de 1 integrante para septiembre del 2020','TRG-1');
...
INSERT INTO `target` VALUES ('TRG-1','Mediante las juntas de cuerpo academico se acordó colegiadamente la necesidad de integrar a un nuevo miembro en el Cuerpo Academico que cuente con titulo de doctor','Incrementar el numero de integrantes del CA','Pendiente','P_LIS_UVitsCAA'),('TRG-2','ObjetivoPrueba','ObjetivoPrueba','Pendiente','P_LIS_UVitsCAA');
...
INSERT INTO `workplan` VALUES ('P_LIS_UVitsCAA','2020-12-04','2020-12-04','AGP-1','SASO750909HDFNNS05');
...
-- Dump completed on 2021-06-30 16:43:14
